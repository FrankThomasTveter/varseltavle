...
function Database() {
	...
	for (var ii=0;ii<lenr;ii++) {
	    ...
	    ret[frag]= {age:age,epoch:epoch,ifirst:ifirst,ilast:ilast,dfirst:dfirst,dlast:dlast,frag:frag,cnt:cnt};
	};
	return ret;
    };
	...
	for (var ii=0;ii<lenp;ii++) {
		...
		if (json !==undefined && json.data !==undefined) {
		    ...
		    if (ifirst !== undefined && json.ifirst !== undefined && ifirst < json.ifirst) {
			ifirst=json.ifirst;
		    } else if (ifirst === undefined && json.ifirst !== undefined) {
			ifirst=json.ifirst;
		    }
		    if (ilast !== undefined && json.ilast !== undefined && ilast > json.ilast) {
			ilast=json.ilast;
		    } else if (ilast === undefined && json.ilast !== undefined) {
			ilast=json.ilast;
		    }
		    if (dfirst !== undefined && json.dfirst !== undefined && dfirst < json.dfirst) {
			dfirst=json.dfirst;
		    } else if (dfirst === undefined && json.dfirst !== undefined) {
			dfirst=json.dfirst;
		    }
		    if (dlast !== undefined && json.dlast !== undefined && dlast > json.dlast) {
			dlast=json.dlast;
		    } else if (dlast === undefined && json.dlast !== undefined) {
			dlast=json.dlast;
		    }
		} else {
	...
	return {data:data,epoch:epoch,ifirst:ifirst,ilast:ilast,dfirst:dfirst,dlast:dlast};
    };
