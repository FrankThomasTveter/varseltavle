...
var Default={deffile:"defaults.json", // defaults file, contains default setup...
	     other:undefined,
	     trash:undefined};

Default.init=function(url,Utils){
    var par="Default"+Utils.version;
    Utils.init(par,Default);
}

Default.loadDefault=function( Database,Threshold,Path,Show,Layout,Html,Colors,callbacks ) {
